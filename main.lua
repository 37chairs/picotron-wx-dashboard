...
print(" ")
print("Time: " .. get_bytes(wx_data, 1, 1) .. ":" ..get_bytes(wx_data, 2, 2) .. ":" .. get_bytes(wx_data, 3, 3))
print(" ")
print("Temperature: " .. get_bytes(wx_data, 4, 4) .. " F")
print(" ")
print("Humidity: " .. get_bytes(wx_data, 5, 5) .. " %")
print(" ")
print("Pressure: " .. get_bytes(wx_data, 6, 7) .. " mb")
print(" ")
print("Wind Speed: " .. get_bytes(wx_data, 8, 8) .. " mph")